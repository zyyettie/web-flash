...
-- ----------------------------
INSERT INTO `t_sys_notice` (`id`, `title`, `type`, `content`, `create_time`, `create_by`, `modify_time`, `modify_by`) VALUES ('1', 'SYSTEM', '10', 'Welcome to China Stone Purchase System', '2019-05-11 08:53:20', '1', '2019-05-12 23:30:58', '1');
...
INSERT INTO `t_sys_user` (`id`, `create_by`, `create_time`, `modify_by`, `modify_time`, `account`, `avatar`, `birthday`, `deptid`, `email`, `name`, `password`, `phone`, `roleid`, `salt`, `sex`, `status`,  `version`,  `company_name`,  `address`,  `registration_no`,  `tax_no`,  `payment_terms`,  `payment_type`, `reg_type`, `id_file`, `id_no`)
  VALUES ('-1', null, null, null, null, 'system', null, null, null, null, 'System', null, null, null, null, null, null, null, 'system', null, null, null, null, null, null, 0, null);
INSERT INTO `t_sys_user` (`id`, `create_by`, `create_time`, `modify_by`, `modify_time`, `account`, `avatar`, `birthday`, `deptid`, `email`, `name`, `password`, `phone`, `roleid`, `salt`, `sex`, `status`,  `version`,  `company_name`,  `address`,  `registration_no`,  `tax_no`,  `payment_terms`,  `payment_type`, `reg_type`, `id_file`, `id_no`)
  VALUES ('1', null, '2016-01-29 08:49:53', '1', '2019-03-20 23:45:24', 'admin', null, '2017-05-05 00:00:00', '27', 'purchase@mailchinastone.com', 'Admin', 'b5a51391f271f062867e5984e2fcffee', null, '1', '8pgby', '2', '1', '25', null, null, null, null, null, null, null, 0, null);
INSERT INTO `t_sys_user` (`id`, `create_by`, `create_time`, `modify_by`, `modify_time`, `account`, `avatar`, `birthday`, `deptid`, `email`, `name`, `password`, `phone`, `roleid`, `salt`, `sex`, `status`,  `version`,  `company_name`,  `address`,  `registration_no`,  `tax_no`,  `payment_terms`,  `payment_type`, `reg_type`, `id_file`, `id_no`)
  VALUES ('48', null, '2018-09-13 17:21:02', '1', '2019-01-09 23:05:51', 'tenderadmin', null, '2017-12-31 00:00:00', '28', 'purchase@mailchinastone.com', 'tenderadmin', 'b5a51391f271f062867e5984e2fcffee', '', '4,', '8pgby', '1', '1', null, null, null, null, null, null, null, null, 0, null);
INSERT INTO `t_sys_user` (`id`, `create_by`, `create_time`, `modify_by`, `modify_time`, `account`, `avatar`, `birthday`, `deptid`, `email`, `name`, `password`, `phone`, `roleid`, `salt`, `sex`, `status`,  `version`,  `company_name`,  `address`,  `registration_no`,  `tax_no`,  `payment_terms`,  `payment_type`, `reg_type`, `id_file`, `id_no`)
  VALUES ('49', null, '2018-09-13 17:21:02', '1', '2019-01-09 23:05:51', 'paymentadmin', null, '2017-12-31 00:00:00', '30', 'purchase@mailchinastone.com', 'paymentadmin', 'b5a51391f271f062867e5984e2fcffee', '', '6,', '8pgby', '1', '1', null, null, null, null, null, null, null, null, 0, null);
INSERT INTO `t_sys_user` (`id`, `create_by`, `create_time`, `modify_by`, `modify_time`, `account`, `avatar`, `birthday`, `deptid`, `email`, `name`, `password`, `phone`, `roleid`, `salt`, `sex`, `status`,  `version`,  `company_name`,  `address`,  `registration_no`,  `tax_no`,  `payment_terms`,  `payment_type`, `reg_type`, `id_file`, `id_no`)
  VALUES ('50', null, '2018-09-13 17:21:02', '1', '2019-01-09 23:05:51', 'nam', null, '2017-12-31 00:00:00', '28', 'nam@mailchinastone.com', 'Nam', 'b5a51391f271f062867e5984e2fcffee', '', '6,', '8pgby', '1', '1', null, null, null, null, null, null, null, null, 0, null);
